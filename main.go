...
// @externalDocs.url            https://github.com/carefuly/careful-admin-go-gin
func main() {
	// 初始化日志
	...
	// 初始化缓存
	configManager.RelyConfig.Redis = ioc.InitCache(configManager.Config.Cache)
	// Token密钥
	configManager.RelyConfig.Token = configManager.Config.Token
