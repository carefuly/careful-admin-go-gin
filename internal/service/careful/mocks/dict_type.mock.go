...
func (m *MockDictTypeService) Import(ctx context.Context, user system.User, listMap []map[string]string) _import.ImportResult {
	m.ctrl.T.Helper()
...
func (mr *MockDictTypeServiceMockRecorder) Import(ctx, user, listMap interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Import", reflect.TypeOf((*MockDictTypeService)(nil).Import), ctx, user, listMap)
}
