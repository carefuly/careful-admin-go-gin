...
type OperateLogger struct {
	...
	RequestUsername string `gorm:"size:40;index:idx_search;column:requestUsername;comment:请求用户名" json:"requestUsername"`                // 请求用户名
	RequestTime     string `gorm:"size:40;column:requestTime;comment:请求耗时" json:"requestTime"`                                          // 请求耗时
	RequestStatus   int    `gorm:"type:int;column:requestStatus;comment:响应状态码" json:"requestStatus"`                                    // 响应状态码
	RequestMethod   string `gorm:"size:20;index:idx_search;column:requestMethod;comment:请求方式" json:"requestMethod"`                     // 请求方式
	RequestIp       string `gorm:"size:20;column:requestIp;comment:请求IP地址" json:"requestIp"`                                            // 请求IP地址
	RequestPath     string `gorm:"size:255;column:requestPath;comment:请求地址" json:"requestPath"`                                         // 请求地址
	...
	RequestOs       string `gorm:"size:40;column:requestOs;comment:操作系统" json:"requestOs"`                                              // 操作系统
	RequestBrowser  string `gorm:"size:64;column:requestBrowser;comment:操作浏览器" json:"requestBrowser"`                                   // 操作浏览器
	UserAgent       string `gorm:"size:255;column:userAgent;comment:用户代理" json:"userAgent"`                                             // 用户代理
