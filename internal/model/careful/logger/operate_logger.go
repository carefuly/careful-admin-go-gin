...
type OperateLogger struct {
	...
	RequestUsername string `gorm:"size:40;index:idx_search;column:request_username;comment:请求用户名" json:"request_username"`              // 请求用户名
	RequestTime     string `gorm:"size:40;column:request_time;comment:请求耗时" json:"request_time"`                                        // 请求耗时
	RequestStatus   int    `gorm:"type:int;column:request_status;comment:响应状态码" json:"request_status"`                                  // 响应状态码
	RequestMethod   string `gorm:"size:20;index:idx_search;column:request_method;comment:请求方式" json:"request_method"`                   // 请求方式
	RequestIp       string `gorm:"size:20;column:request_ip;comment:请求IP地址" json:"request_ip"`                                          // 请求IP地址
	RequestPath     string `gorm:"size:255;column:request_path;comment:请求地址" json:"request_path"`                                       // 请求地址
	...
	RequestOs       string `gorm:"size:40;column:request_os;comment:操作系统" json:"request_os"`                                            // 操作系统
	RequestBrowser  string `gorm:"size:64;column:request_browser;comment:操作浏览器" json:"request_browser"`                                 // 操作浏览器
	UserAgent       string `gorm:"size:255;column:user_agent;comment:用户代理" json:"user_agent"`                                           // 用户代理
