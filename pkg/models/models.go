...
type CoreModels struct {
	...
	Creator    string     `gorm:"type:varchar(110);index;column:creator;comment:创建人" json:"creator"`           // 创建人
	Modifier   string     `gorm:"type:varchar(110);index;column:modifier;comment:修改人" json:"modifier"`         // 修改人
	BelongDept string     `gorm:"type:varchar(110);index;column:belong_dept;comment:数据归属部门" json:"belongDept"` // 数据归属部门
