...
type CoreModels struct {
	Id         string     `gorm:"size:110;primaryKey;column:id;comment:主键ID" json:"id"`                // 主键ID(自增)
	...
	Creator    string     `gorm:"size:110;index;column:creator;comment:创建人" json:"creator"`            // 创建人
	Modifier   string     `gorm:"size:110;index;column:modifier;comment:修改人" json:"modifier"`          // 修改人
	BelongDept *string    `gorm:"size:110;index;column:belong_dept;comment:数据归属部门" json:"belong_dept"` // 数据归属部门
